...
async function run() {
  ...
  results.push({ step: "nightly_canary", ...(await runNode(path.join(ROOT, "scripts", "nightly-canary.js"))) });
  results.push({ step: "perf_gate", ...(await runNode(path.join(ROOT, "scripts", "perf-gate.js"))) });
