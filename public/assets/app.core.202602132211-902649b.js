import {
  ...
  setDeviceName,
  getDeviceName,
} from "./app.api.202602132211-902649b.js";
import { getAppState as getAppStateInternal, setAppState } from "./app.state.202602132211-902649b.js";
import { qs, qsa, el, clear, setText, formatMinutes, formatPct, applyI18n, getDictValue } from "./app.ui.202602132211-902649b.js";
...
export const BUILD_ID = "202602132211-902649b";
...
async function loadControllers() {
  if (!controllersModule) {
    controllersModule = import("./controllers.202602132211-902649b.js");
  }
...
function initDay({ initialDateISO } = {}) {
  ...
  const beginBtn = document.getElementById("begin-personalization")
    || Array.from(document.querySelectorAll("button")).find((btn) => btn.textContent?.trim() === "Begin personalization");
  ...
  if (beginBtn && beginBtn.dataset.boundPersonalization !== "1") {
    beginBtn.addEventListener("click", startOnboarding);
    beginBtn.dataset.boundPersonalization = "1";
    console.log("[day] begin listener bound");
  }
