import {
  ...
  setDeviceName,
  getDeviceName,
} from "./app.api.202602100118-a07d2ef.js";
import { getAppState as getAppStateInternal, setAppState } from "./app.state.202602100118-a07d2ef.js";
import { qs, qsa, el, clear, setText, formatMinutes, formatPct, applyI18n, getDictValue } from "./app.ui.202602100118-a07d2ef.js";
...
export const BUILD_ID = "202602100118-a07d2ef";
...
async function loadControllers() {
  if (!controllersModule) {
    controllersModule = import("./controllers.202602100118-a07d2ef.js");
  }
