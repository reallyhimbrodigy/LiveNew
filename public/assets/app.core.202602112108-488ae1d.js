import {
  ...
  setDeviceName,
  getDeviceName,
} from "./app.api.202602112108-488ae1d.js";
import { getAppState as getAppStateInternal, setAppState } from "./app.state.202602112108-488ae1d.js";
import { qs, qsa, el, clear, setText, formatMinutes, formatPct, applyI18n, getDictValue } from "./app.ui.202602112108-488ae1d.js";
...
export const BUILD_ID = "202602112108-488ae1d";
...
async function loadControllers() {
  if (!controllersModule) {
    controllersModule = import("./controllers.202602112108-488ae1d.js");
  }
...
export async function bootstrapApp({ page } = {}) {
  ...
  if ((protectedPages.has(resolvedPage) || isProtectedPath(path)) && !hasValidToken(getToken())) {
    clearTokens();
    redirectToLogin(currentPathWithQuery());
    return;
  }
