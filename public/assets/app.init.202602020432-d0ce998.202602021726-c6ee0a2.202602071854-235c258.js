import { apiGet, apiPost, setToken, setRefreshToken } from "./app.api.202602020432-d0ce998.js";
import { getAppState, setAppState } from "./app.state.202602020432-d0ce998.js";
import {
  initBaseUi,
  bindAuth,
  ...
  showErrorScreen,
  t,
} from "./app.core.202602020432-d0ce998.js";

let controllersModule = null;
async function loadControllers() {
  if (!controllersModule) {
    controllersModule = import("./controllers.202602020432-d0ce998.js");
  }
